...
namespace NonogramSolver.Core.Tests
{
    public class PuzzleSolverTests: TestClassBase
    {
        ...
        [Test]
        public void Solve_House15X15Puzzle_Resolved()
        {
            var solver = GetService<ISolver>();
            var solution = GetHouse15X15PuzzleSolution();
            
            var solvedPuzzle = solver.Solve(GetHouse15X15Puzzle());

            Assert.True(IsArrayEquals(solution, solvedPuzzle.Desk));
        }
        
        [Test]
        public void Solve_Castle15X15Puzzle_Resolved()
        {
            var solver = GetService<ISolver>();
            var solution = GetCastle15X15Solution();
            
            var solvedPuzzle = solver.Solve(GetCastle15X15Puzzle());

            Assert.True(IsArrayEquals(solution, solvedPuzzle.Desk));
        }
        
        private static Puzzle GetHouse15X15Puzzle()
        {
        ...
        private static Puzzle GetCastle15X15Puzzle()
        {
            var verticalLines = new List<List<LineNumber>>
            {
                new()
        ...
        private static Cell[][] GetCastle15X15Solution()
        {
            const int rows = 15;
        ...
        private static Cell[][] GetHouse15X15PuzzleSolution()
        {
            const int rows = 15;
            const int columns = 15;
            var desk = new Cell[rows][];
